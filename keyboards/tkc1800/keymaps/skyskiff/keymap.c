/* Copyright 2021 skyskiff - htprww@gmail.com 
 * 1800
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ,-------------------------------------------------------.     ,-------------------.
   * |Esc| F1| F2| F3| F4| | F5| F6| F7| F8| | F9|F10|F11|F12|     |Mode|Mute|VolD|VolU|
   * `-------------------------------------------------------'     |-------------------|
   *                                                               |Cont|StOt|Home|PgUp|
   * ,-----------------------------------------------------------. |-------------------|
   * | ~ | 1 |  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|\ | Del| |Step|StIn|End |PgDn|
   * |-----------------------------------------------------------| |-------------------|
   ...
   * |--------------------------------------------------------'----`--------------| Ent|
   * |Ctrl|Alt |Gui |      Space           |Gui |Alt |Fn|Left |Down|Rght| 0  | .  |    |
   * `---------------------------------------------------------------------------------'
   */
  [MAC] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,                        KC_RGUI, KC_RALT, MO(FN),          KC_LEFT, KC_DOWN, KC_RGHT,       KC_P0,   KC_PDOT, KC_PENT  \
  ),
  [WIN] = LAYOUT(
    ...
    KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,      KC_UP,       KC_P1,   KC_P2,    KC_P3,   XXXXXXX, \
    KC_LALT, KC_LGUI, KC_LCTL,                   KC_SPC,                        KC_RCTL, KC_RGUI, MO(FN),          KC_LEFT, KC_DOWN, KC_RGHT,       KC_P0,    KC_PDOT, KC_PENT  \
  ),
  [GME] = LAYOUT(
    ...
    MO(NAV), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, XXXXXXX, KC_ENT,           KC_P4,   KC_P5,    KC_P6,   C(KC_C), \
    KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,      KC_UP,       KC_P1,   KC_P2,    KC_P3,   XXXXXXX, \
    KC_LCTL, KC_RBRC, KC_LALT,                   KC_SPC,                        KC_RCTL, KC_RGUI, MO(FN),          KC_LEFT, KC_DOWN, KC_RGHT,       KC_P0,    KC_PDOT, KC_PENT  \
  ),
  /* non layer */
  [NON] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,                        XXXXXXX, XXXXXXX, MO(FN),         XXXXXXX, XXXXXXX, XXXXXXX,        XXXXXXX, XXXXXXX, XXXXXXX  \
  ),
